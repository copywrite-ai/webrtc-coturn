...
export ORTM_BACKGROUND_ALPHA="${ORTM_BACKGROUND_ALPHA:-0.15}"
export ORTM_CELL_ALPHA="${ORTM_CELL_ALPHA:-0.65}"
export ORTM_TIMING_COLUMN_ALPHA="${ORTM_TIMING_COLUMN_ALPHA:-${ORTM_CELL_ALPHA}}"
export ORTM_BORDER_ALPHA="${ORTM_BORDER_ALPHA:-1.0}"
export ORTM_FINDER_LAYOUT="${ORTM_FINDER_LAYOUT:-four}"
...
export PYTHONPATH="${ROOT_DIR}/vendor/open-raster-timing-marker/src/python${PYTHONPATH:+:${PYTHONPATH}}"
...
echo "  ortm timing column alpha: ${ORTM_TIMING_COLUMN_ALPHA}"
echo "  ortm border alpha: ${ORTM_BORDER_ALPHA}"
echo "  ortm finders : ${ORTM_FINDER_LAYOUT}"
